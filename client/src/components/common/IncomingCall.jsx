...
function IncomingCall() {
  ...
  return (
    <div className="h-24 w-90 fixed bottom-8 mb-0 right-10 z-50 rounded-sm flex gap-5 items-center justify-start p-4 bg-conversation-panel-background text-white drop-shadow-2xl border-icon-green border-2 py-14">
      <div>
        <Image
